...
sub Fxs(){
 Hit(){
    Fx(SurfaceId_Water,"coll_water",0,0);
    Fx(SurfaceId_Water,"coll_water_ring",0,0);
    Fx(SurfaceId_Snow,"coll_mud",0,0);
    Fx(SurfaceId_Grass,"coll_ground",0,0);
    Fx(SurfaceId_Ground,"coll_ground",0,0);
    Fx(SurfaceId_Stone,"coll_ground",0,0);
    Fx(SurfaceId_Sand,"coll_ground",0,0);
    Fx(SurfaceId_Tarmac,"coll_ground",0,0);
    Fx(SurfaceId_Mud,"coll_mud",0,0);
    Fx(SurfaceId_Gravel,"coll_ground",0,0);
}
return 0;
}
